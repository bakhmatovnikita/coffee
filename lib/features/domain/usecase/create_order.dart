...
class CreateOrder extends UseCase<OrderEntiti, CresteOrderParams>{
  ...
  Future<Either<Failure, OrderEntiti>> call(CresteOrderParams params) async {
    return await coffeeRepository.createOrder(params.endpoint, params.item, params.phone, params.organizationId);
  }
...
class CresteOrderParams extends Equatable{
  ...
  const CresteOrderParams({required this.endpoint, required this.item, required this.phone, required this.organizationId});
  @override
