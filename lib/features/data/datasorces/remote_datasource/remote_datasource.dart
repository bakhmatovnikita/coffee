...
abstract class RemoteDatasource {
  ...
  Future<TerminalGroupModel> fetchTerminalGroup(String endpoint, String organizationId);
  Future<OrderModel> createOrder(String endpoint, List<Item> item, String phone, String organizationId);
}
