import 'package:cofee/features/data/models/products/size_price_models.dart';
import 'package:cofee/features/domain/entiti/products/product_entiti.dart';
import 'package:cofee/features/domain/entiti/products/size_price_entiti.dart';
...
class ProductModel extends ProductEntiti {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        sizePrices: List<SizePriceEntiti>.from(
            json["sizePrices"].map((x) => SizePriceModels.fromJson(x))),
        name: json['name'],
