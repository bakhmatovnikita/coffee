...
class UserInfoModel extends UserInfoEntiti {
  ...
  factory UserInfoModel.fromJson(Map<String, dynamic> json) => UserInfoModel(
        ...
        walletBalances: List<WalletBalanceEntiti>.from(
            (json["walletBalances"] as List<dynamic>).map((x) => WalletBalanceModel.fromJson(x)).toList()),
        ...
        personalDataConsentFrom: json["personalDataConsentFrom"],
        personalDataConsentTo: json["personalDataConsentTo"],
